...
controllers. This fork of [im-0/hpsahba](https://github.com/im-0/hpsahba) removes the requirement to set `hpsa_use_nvram_hba_flag=1`. This makes life easier in general, but was motivated by the difficulty in setting module params in Truenas SCALE.
